...
public class Tools_QA {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\Abc\\Desktop\\Sel\\chromedriver.exe");
		...
		w.findElement(By.id("uploadFile")).sendKeys("C:\\Users\\Abc\\Desktop\\sample");
		Thread.sleep(2000);
	...
	//-------------------------------------------------Practice form-----------------------------------------	
	   ...
	   //file upload
	     w.findElement(By.id("uploadPicture")).sendKeys("C:\\Users\\Abc\\Desktop\\sample"); 
...
//----------------------------------------- Widgets ---------------------------------------------------------------------------				
		...
		// for Accordian
				...
				List<WebElement> L3= w.findElements(By.tagName("a"));
				System.out.println("Total Links are : "+L3.size());
				w.navigate().back();
				Thread.sleep(2000);
...
//----------------------------------------------Book store---------------------------------------------------------
				...
				// Widgets Module
				// for scroll down the page & click on widgets 
				JavascriptExecutor js81= (JavascriptExecutor) w; 
				
				js81.executeScript("window.scrollBy(0, 300)");
		...
		// for Date Picker
			...
			// for Select Date
				w.findElement(By.id("datePickerMonthYearInput")).click();
				Select s5= new Select(w.findElement(By.className("react-datepicker__month-select")));
				s5.selectByValue("4");
				Thread.sleep(2000);
				
				Select s6= new Select(w.findElement(By.className("react-datepicker__year-select")));
				s6.selectByVisibleText("1993");
				Thread.sleep(2000);
		...
		// for Slider
				...
				WebElement slider1=w.findElement(By.xpath("//*[@id=\"sliderContainer\"]/div[1]/span/input"));
				Actions act1= new Actions(w);
				act1.dragAndDropBy(slider1,-150, 100).perform();     //move to backward
				Thread.sleep(2000);
				act.dragAndDropBy(slider1, 200, 100).perform();     // move to forward
				Thread.sleep(2000);
		...
		// for Tabs
				...
				Thread.sleep(2000);
			//	w.findElement(By.xpath("/html[1]/body[1]/div[2]/div[1]/div[1]/div[2]/div[2]/div[1]/nav[1]/a[4]")).click();
				boolean eleEnabled1=	w.findElement(By.xpath("/html[1]/body[1]/div[2]/div[1]/div[1]/div[2]/div[2]/div[1]/nav[1]/a[4]")).isEnabled();
				System.out.println(eleEnabled1);
				Thread.sleep(2000);
		...
		// for 	Tool Tips
				...
				Actions At1 = new Actions(w);
				At1.moveToElement(w.findElement(By.xpath("//button[@id='toolTipButton']"))).perform();
				Thread.sleep(2000);
				
				WebElement text1=w.findElement(By.xpath("//input[@id='toolTipTextField']"));
				Actions At2 = new Actions(w);
				At2.moveToElement(text1).click().keyDown(Keys.SHIFT).sendKeys("Hello").build().perform();
				
				Actions At3 = new Actions(w);
				At3.moveToElement(w.findElement(By.xpath("//a[contains(text(),'Contrary')]"))).perform();
				Thread.sleep(2000);
				
				js.executeScript("window.scrollBy(0,300)");
				Actions At4 = new Actions(w);
				A4.moveToElement(w.findElement(By.xpath("//a[contains(text(),'1.10.32')]"))).perform();
				Thread.sleep(2000);
				w.navigate().back();
				Thread.sleep(2000);
			...
			// for Menu
				...
				Actions At5 = new Actions(w);
				At5.moveToElement(w.findElement(By.xpath("//a[contains(text(),'Main Item 2')]"))).perform();
				w.findElement(By.linkText("Sub Item")).click();
				Thread.sleep(3000);
				
				Actions At6 = new Actions(w);
				At6.moveToElement(w.findElement(By.xpath("//a[contains(text(),'Main Item 2')]"))).perform();

				At6.moveToElement(w.findElement(By.xpath("//a[contains(text(),'SUB SUB LIST »')]"))).perform();
				w.findElement(By.xpath("//a[contains(text(),'Sub Sub Item 2')]")).click();
				Thread.sleep(2000);
		...
		//Select one
				...
				Thread.sleep(2000);
		// Old Style Select Menu
				Select s7= new Select(w.findElement(By.xpath("//select[@id='oldSelectMenu']")));
				s7.selectByValue("4");
				Thread.sleep(2000);
		// multiselect Drop down
		...
		// Standard multi select
				Select s8= new Select(w.findElement(By.xpath("/html[1]/body[1]/div[2]/div[1]/div[1]/div[2]/div[2]/div[1]/div[8]/div[1]/select[1]")));
				s8.selectByVisibleText("Volvo");
				s8.selectByValue("audi");
				Thread.sleep(2000);
